 ...
 * 날짜 : 2023/04/03
 * 이름 : 전인준
 * - v-on:click 대신 @click 주로 사용
 * - select엔 change를 가장 많이 사용
 * - v-on:submit 뒤에 .prevent로 바로 사용가능
 * - v-bind: 는 :로 생략 가능 (단방향)
 * - v-model (양방향)
 */
  ...
  data() {
    return {
      ...
      persons: [
        ...
        { uid: "a102", name: "김우신", age: 21 },
        { uid: "a103", name: "김무신", age: 26 },
        { uid: "a104", name: "김주신", age: 25 },
        { uid: "a105", name: "김두신", age: 29 },
      ],
      count: 0,
